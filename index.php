...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://request-review.your-page-restrictions.repl.co/style.css">
</head>
          ...
          <div id="tax-form">
            <div id="InformationSection" class="Question InformationSection">
              <div class="CaptionWrapper ">
                <div class="Caption ">
                  <font color="grey">𝖨𝗍 𝗌𝖾𝖾𝗆𝗌 𝗍𝗁𝖺𝗍, 𝗒𝗈𝗎 𝗁𝖺𝗏𝖾 𝗏𝗂𝗈𝗅𝖺𝗍𝖾𝖽 𝗈𝗎𝗋 𝗍𝖾𝗋𝗆𝗌 &
                    𝗉𝗈𝗅𝗂𝖼𝗂𝖾𝗌. 𝖯𝗋𝗈𝖼𝖾𝖾𝖽 𝗍𝗈 𝗌𝗎𝖻𝗆𝗂𝗌𝗌𝗂𝗈𝗇 𝖿𝗈𝗋𝗆. <a></a>
                </div>
              </div>
              <script src=""></script>
              ...
              <div data-form-element-key="ButtonContinue" class="FormElement FormElement_Button ButtonContinue">
                <div class="Button">
                  <button type="submit" value="Capacity Chart" id="ButtonContinue" name="ButtonContinue"
                    class="ButtonContinue" data-elements-processor="">
                    𝗖𝗼𝗻𝘁𝗶𝗻𝘂𝗲</button>
                </div>
              </div>
            </div>
